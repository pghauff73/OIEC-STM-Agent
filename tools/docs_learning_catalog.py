...
INVENTION_TIMELINE = (
    ...
    TimelineEntry("problem-map", "Model the territory", "A plausible first solution can hide missing objects and dependencies.", "OURD names the object universe, relations, boundaries, exclusions, and unknowns.", ("README.md", "ourd/egcf/catalog.py")),
...
ACRONYMS = (
    ...
    AcronymRecord("STM", "STM v1.2 bounded-transition layer", "The bounded state-transition part of OIEC-STM-Agent.", "A turnstile that admits only a checked transition rather than any movement.", "The current source names STM as a bounded-transition layer; it does not define STM as ordinary conversational short-term memory.", ("eon", "evidence-gate"), "T00", ("README.md", "OIEC_STMV1_2_IMPLEMENTATION_PLAN.md")),
    ...
    AcronymRecord("OURD", "Object-Universe-Relation-Dependency", "Maps what belongs to a problem and how the parts relate.", "List every part of a lamp circuit before blaming the bulb.", "A canonical relational problem representation with explicit boundaries and unresolved relations.", ("ourd",), "T04", ("README.md", "tools/docs_concept_catalog.py")),
