...
TASK_ROUTES = (
    ...
    TaskRoute("use-ollama", "Use OIEC with direct llama.cpp", "docs/tasks/USE_OLLAMA.md", "Run a local model file through llama.cpp without a provider webserver.", ("T01", "T02"), ("llama.cpp", "local model", "model file", "provider setup")),
...
ACRONYMS = (
    ...
    AcronymRecord("API", "Application Programming Interface", "A defined way for software components to communicate.", "A labeled socket whose allowed shape and signals are documented.", "The repository uses local Python APIs and governed provider APIs behind explicit process boundaries.", (), "T01", ("README.md",)),
