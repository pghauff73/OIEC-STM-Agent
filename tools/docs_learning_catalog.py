...
INVENTION_TIMELINE = (
    ...
    TimelineEntry("problem-map", "Model the territory", "A plausible first solution can hide missing objects and dependencies.", "OURD decomposes the problem into unique objects, relations, dependencies, boundaries, exclusions, and unknowns.", ("README.md", "ourd/egcf/catalog.py")),
...
ACRONYMS = (
    ...
    AcronymRecord("OURD", "Object Unique Relational Decomposition", "Decomposes a problem into unique objects and the relations between them.", "List every part of a lamp circuit before blaming the bulb.", "A canonical relational decomposition into unique objects, their relations, dependencies, boundaries, exclusions, and unresolved relations.", ("ourd",), "T04", ("README.md", "tools/docs_concept_catalog.py")),
